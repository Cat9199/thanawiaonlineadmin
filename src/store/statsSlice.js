...
const urlName = "walidelgendy";

export const getUsersCount = createAsyncThunk("getUsersCount", async() => {
    try {
        const res = await axios.get(
            "https://thanawionline.e3lanotopia.software/api/th/get_users_count"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getViews = createAsyncThunk("getViews", async() => {
    try {
        const res = await axios.get(
            "https://thanawionline.e3lanotopia.software/api/th/get_videos_views"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getLessonsCount = createAsyncThunk("getLessonsCount", async() => {
    try {
        const res = await axios.get(
            "https://thanawionline.e3lanotopia.software/api/th/get_lessons_count"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getExamsCount = createAsyncThunk("getExamsCount", async() => {
    try {
        const res = await axios.get(
            "https://thanawionline.e3lanotopia.software/api/th/get_exames_count"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const initCodes = createAsyncThunk("initCodes", async(args) => {
    try {
        ...
        let reqOptions = {
            url: "https://thanawionline.e3lanotopia.software/api/th/init_codes",
            method: "POST",
            data: bodyContent,
        };
...
export const initCourse = createAsyncThunk("initCourse", async(args) => {
    try {
        const res = await axios.post(
            "https://thanawionline.e3lanotopia.software/api/th/add_course",
            args
        );
        return res.data;
    } catch (err) {
...
export const initLesson = createAsyncThunk("initLesson", async(args) => {
    try {
        const res = await axios.post(
            "https://thanawionline.e3lanotopia.software/api/th/add_lesson",
            args
        );
        return res.data;
    } catch (err) {
...
export const getLessons = createAsyncThunk("getLessons", async(args) => {
    try {
        const res = await axios.get(
            `https://thanawionline.e3lanotopia.software/api/th/get_lessons/${args}`
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const enrollCourseForUser = createAsyncThunk(
    ...
    async(args) => {
        try {
            const res = await axios.post(
                `https://thanawionline.e3lanotopia.software/api/th/enroll_course`,
                args
            );
...
export const deleteCourse = createAsyncThunk("deleteCourse", async(args) => {
    try {
        const res = await axios.get(
            `https://thanawionline.e3lanotopia.software/api/th/delete_course/${args}`
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const deleteLesson = createAsyncThunk("deleteLesson", async(args) => {
    try {
        const res = await axios.get(
            `https://thanawionline.e3lanotopia.software/api/th/delete_lesson/${args}`
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const editLesson = createAsyncThunk("editLesson", async(args) => {
    try {
        const res = await axios.post(
            `https://thanawionline.e3lanotopia.software/api/th/edit_lesson/${args.id}`,
            args.data
        );
...
export const editCourse = createAsyncThunk("editCourse", async(args) => {
    ...
    try {
        const res = await axios.post(
            `https://thanawionline.e3lanotopia.software/api/th/edit_course/${args.id}`,
            args.data
        );
