    ...
    async() => {
        try {
            const res = await axios.get(
                "https://thanawionline.e3lanotopia.software/api/th/get_all_notificashen"
            );
            return res.data;
        } catch (err) {
            return err.message;
...
export const getAllUsers = createAsyncThunk("getAllUsers", async() => {
    try {
        const res = await axios.get(
            "https://thanawionline.e3lanotopia.software/api/th/get_all_users"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getAllCourses = createAsyncThunk("getAllCources", async() => {
    try {
        const res = await axios.get(
            "https://thanawionline.e3lanotopia.software/api/th/get_all_courses"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const SearchByYearSectionLocation = createAsyncThunk(
    ...
    async(args) => {
        try {
            const res = await axios.get(
                `https://thanawionline.e3lanotopia.software/api/th/get_users/${args.year}/${args.section}/${args.location}`
            );
            return res.data;
        } catch (err) {
...
export const getOneUser = createAsyncThunk("searchOneUser", async(args) => {
    try {
        const res = await axios.get(
            `https://thanawionline.e3lanotopia.software/api/th/get_user_data/${args.email}`
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getUserCourses = createAsyncThunk("userCourses", async(args) => {
    try {
        const res = await axios.get(
            `https://thanawionline.e3lanotopia.software/api/th/get_user_courses/${args}`
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getNotificationsCount = createAsyncThunk(
    ...
    async() => {
        try {
            const res = await axios.get(
                `https://thanawionline.e3lanotopia.software/api/th/count_unread_notificashen`
            );
            return res.data;
        } catch (err) {
            return err.message;
